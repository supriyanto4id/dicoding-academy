...
class CardHeroAdapter(private val listHero:ArrayList<Hero>):RecyclerView.Adapter<CardHeroAdapter.CardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardHeroAdapter.CardViewHolder {
       var view:View = LayoutInflater.from(parent.context).inflate(R.layout.item_card_view,parent,false)
